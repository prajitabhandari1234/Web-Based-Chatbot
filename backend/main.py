...
def chat(request: ChatRequest):
    """
    Process the latest user message together with previous conversation
    history and return an AI-generated response.

    Args:
        request (ChatRequest): The validated chat request containing the
            latest message and previous conversation history.

    Returns:
        dict: The response generated by the language model or a security
            warning when suspicious input is detected.
    """
