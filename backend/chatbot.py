...
def generate_response(
    ...
    """
    Generate an AI response using the current question and previous
    conversation history.

    Args:
        user_message (str): The latest message submitted by the user.
        history (list[dict[str, str]]): Previous user and assistant messages.

    Returns:
        str: The response generated by the Gemini language model.
    """

    # Limit the amount of context sent to the model so the request
    # does not grow indefinitely during long conversations.
